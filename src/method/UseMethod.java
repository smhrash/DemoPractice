...
public class UseMethod {
	...
	// Return Type Method/ Non Parameterized Return Type Method:/Static type method
	...
	public static void main(String[] args) {
		...
		obj.doSubstruction();
		obj.doSubstruction(200, 65); // return type parameterized method call by object name
